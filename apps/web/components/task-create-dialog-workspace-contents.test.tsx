...
describe("workspace contents creation contract", () => {
  it("serializes mixed selections in their visible order", () => {
    const selections: TaskRepositorySelection[] = [
      { kind: "local", key: "repo", repositoryId: "repo-local", branch: "feature/local" },
    ...
    const payload = buildWorkspaceSourcesPayload({
      ...
      workspaceRepositories: [
        { id: "repo-local", default_branch: "main" } as unknown as Repository,
      ],
