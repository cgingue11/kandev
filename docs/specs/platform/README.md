...
- [GitHub CLI shim re-entry guard](requirements/github-cli-shim-reentry-guard.md)
...
- [GitHub CLI shim re-entry guard](system-design/github-cli-shim-reentry-guard.md)
