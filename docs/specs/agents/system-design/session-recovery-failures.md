...
| Provider quota | No new mutation invented | Existing provider/model/reset guidance; if supported recovery metadata supplies an eligible operation, use it; otherwise wait/prerequisite explanation |
