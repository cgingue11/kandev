...
| --- | --- |
| `AC-TASKS-WORKFLOW-STEP-AGENT-START-OWNERSHIP-007.1` through `.4` | Desktop scenario in `apps/web/e2e/tests/workflow/workflow-settings.spec.ts` |
| `AC-TASKS-WORKFLOW-STEP-AGENT-START-OWNERSHIP-007.5` | Phone scenario in `apps/web/e2e/tests/workflow/mobile-workflow-settings.spec.ts` |
